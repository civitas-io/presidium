...
|---|---|---|---|
| **AgentGateway** | `presidium_contrib.agentgateway` | ✅ **Reference — fully built** | Linux Foundation, Rust, one data plane for LLM + MCP + A2A, native CEL policies + OTel. Already the adapter this design was originally hardcoded to. |
